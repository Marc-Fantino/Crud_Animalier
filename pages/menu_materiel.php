...
<div class="container-fluid bg-warning">
    ...
    <h3 class="text-center ">Accéssoires</h3>

    <div class="row">
            <?php
            foreach($statement as $produit){
                $date = new DateTime($produit['date_depot']);
                ?>
                <div class="col-md-4 col-sm-12 p-1 rounded-top">
                    <div class="card bg-dark" style="height: 100%;">
                        ...
                        <div class="card-body text-center">
                                <p class="card-text"><?= $date->format("d/m/Y")?></p>
                                <p>Disponible :
                                <?php
                                ...
                                <div class="container d-flex justify-content-center text-center">
                                    ...
                                    <a href="suppression_materiel.php?id_produit=<?= $produit['id_produit']?>" class="mt-2 btn btn-danger">Suppression produit</a>
                                    <a href="ajout_materiel.php?id_produit=<?= $produit['id_produit']?>" class="mt-2 btn btn-warning">Création produit</a>
                                    <a href="ajout_editer_materiel.php?id_produit=<?= $produit['id_produit']?>" class="mt-2 btn btn-success">édition produit</a>
