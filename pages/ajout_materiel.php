...
<div class="container-fluid bg-warning">
        ...
        <h3 class="text-center">Rajout des produits</h3>
          ...
          <div class="container">
          <form action="traitement_ajouter_un_materiel.php" id="form-login" method="POST" enctype="multipart/form-data">
            ...
            <div class="d-flex justify-content-center-around">
                ...
                <a href="materiel.php" class="btn btn-success">Annuler</a>
            </div>
