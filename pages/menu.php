...
<div class="container-fluid bg-warning">
    ...
    <div class="row">
                    ...
                    <div class="card bg-dark" style="height: 100%;">
                        ...
                        <div class="card-body text-center">
                                ...
                                <div class="container d-flex justify-content-center text-center">
                                    ...
                                    <a href="suppression.php?id_produit=<?= $produit['id_produit']?>" class="mt-2 btn btn-danger">Suppression produit</a>
                                    <a href="ajout_produit.php?id_produit=<?= $produit['id_produit']?>" class="mt-2 btn btn-warning">Création produit</a>
                                    <a href="ajout_editer.php?id_produit=<?= $produit['id_produit']?>" class="mt-2 btn btn-success">édition produit</a>
            ...
            <?php
            foreach($statement1 as $produit1){
                
                ?>
                <div class="col-md-4 col-sm-12 p-1 rounded-top">
                    <div class="card bg-dark" style="height: 100%;">
                        
                            <h4 class="card-title text-info"><?= $produit1['nom_produit']?></h4>
                            <img src="<?= $produit1['image_produit']?>" class="card-img-top img-fluid" alt="<?=$produit1['nom_produit']?>"style="height: 100%;">
                        
                        <div class="card-body text-center">
                                
                                <p>Disponible :
                                <?php
                                    if($produit1['stock_produit'] == true){
                                        echo "Oui";
                                ...
                                <div class="container d-flex justify-content-center text-center">
                                    <a href="materiel.php?id_produit=<?= $produit1['id_produit']?>" class="mt-2 btn btn-success">Detail  produit</a>
                                    <!-- Button trigger modal -->
                                    <button type="button" class="mt-2 btn btn-primary" data-bs-toggle="modal" data-bs-target="#Materiel<?=$produit1['id_produit']?>">
                                      En savoir plus
                                    </button>
                                    <a href="suppressionMateriel.php?id_produit=<?= $produit1['id_produit']?>" class="mt-2 btn btn-danger">Suppression  produit</a>
                                    <a href="ajout_produit.php?id_produit=<?= $produit['id_produit']?>" class="mt-2 btn btn-warning">Création produit</a>
                                    <!-- Modal -->
                                    <div class="modal fade" id="Materiel<?=$produit1['id_produit']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                      <div class="modal-dialog modal-fullscreen">
                                        <div class="modal-content"> 
                                          <div class="modal-header text-center">
                                            <h5 class="modal-title" id="exampleModalLabel"><?= $produit1['nom_produit']?></h5>
                                            
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                          </div>
                                          <div class="modal-body" id="jungle" >
                                          <div class="card w-25 bg-dark rounded-top text-center">
                                            <img src="<?= $produit1['image_produit']?>" class="card-img-top img-fluid" alt="<?=$produit1['nom_produit']?>">
                                            
                                            </div>  
                                            <p><?= $produit1['description_produit']?></p>
                                          </div>
                                          <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
